    ...
    Class Model_events extends CI_Model {
        ...
        public function get_all() {
            $query = $this->db->query("SELECT
                ...
                bosses.name AS name_boss, raids.description AS description_raid
                FROM events LEFT JOIN bosses ON events.id_boss = bosses.id
        ...
        public function get_list() {
            $query = $this->db->query("SELECT
                ...
                FROM bosses INNER JOIN events ON events.id_boss = bosses.id
            ;");
            $bosses = array();
            if ($query->num_rows() > 0) {
                foreach ($query->result_array() as $row) {
