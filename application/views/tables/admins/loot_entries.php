                            ...
                            <tbody>
                                <?php
                                    for ($i = 0; $i < count($loot_list); $i++) {
                                        ...
                                        echo "<td class='align-middle'><div class='btn-group'><a title='Modify " . $loot_entry['name_drop'] . ' - ' . $loot_entry['name_character'] . "' href='" . site_url() . 'loot/show_modify/' . $loot_entry['id'] . "' class='btn btn-primary btn-sm'><i class='material-icons align-middle'>settings</i></a>";
