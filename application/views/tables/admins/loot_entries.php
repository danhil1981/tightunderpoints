                    <div id="loot" class="d-none table-responsive">
                            ...
                            <tbody>
                                <?php
                                    for ($i = 0; $i < count($loot_list); $i++) {
                                        ...
                                        echo "<tr><th scope='row' class='fit align-middle'>" . $loot_entry['id'] . '</th>';
                                        echo "<td class='align-middle'>" . $loot_entry['name_drop'] . '</td>';
                                        echo "<td class='align-middle'>" . $loot_entry['name_character'] . '</td>';
                                        echo "<td class='fit align-middle'><div class='btn-group'><a title='Modify " . $loot_entry['name_drop'] . ' - ' . $loot_entry['name_character'] . "' href='" . site_url() . 'loot/show_modify/' . $loot_entry['id'] . "' class='btn btn-success btn-sm'><i class='material-icons align-middle'>settings</i></a>";
