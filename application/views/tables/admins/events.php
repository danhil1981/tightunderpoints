                            ...
                            <tbody>
                                <?php
                                    for ($i = 0; $i < count($events_list); $i++) {
                                        ...
                                        echo "<td class='align-middle'><div class='btn-group'><a title='Modify " . $event['timestamp'] . ' - ' . $event['name_boss'] . "' href='" . site_url() . 'events/show_modify/' . $event['id'] . "' class='btn btn-success btn-sm'><i class='material-icons align-middle'>settings</i></a>";
