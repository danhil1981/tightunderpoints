                            ...
                            <tbody>
                                <?php
                                    for ($i = 0; $i < count($users_list); $i++) {
                                        ...
                                        echo '</td>';
                                        echo "<td class='align-middle'><div class='btn-group'><a title='Modify " . $user['name'] . "' href='" . site_url() . 'users/show_modify/' . $user['id'] . "' class='btn btn-success btn-sm'><i class='material-icons align-middle'>settings</i></a>";
