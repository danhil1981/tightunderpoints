                    <div id="drops" class="d-none table-responsive">
                            ...
                            <tbody>
                                <?php
                                    for ($i = 0; $i < count($drops_list); $i++) {
                                        $drop = $drops_list[$i];
                                        echo "<tr><th scope='row' class='fit align-middle'>" . $drop['id'] . '</th>';
                                        echo "<td class='align-middle'>" . $drop['name_event'] . '</td>';
                                        echo "<td class='align-middle'>" . $drop['name_item'] . '</td>';
                                        echo "<td class='fit align-middle'><div class='btn-group'><a title='Modify " . $drop['name_event'] . ' - ' . $drop['name_item'] . "' href='" . site_url() . 'drops/show_modify/' . $drop['id'] . "' class='btn btn-success btn-sm'><i class='material-icons align-middle'>settings</i></a>";
