                            ...
                            <tbody>
                                <?php
                                    for ($i = 0; $i < count($drops_list); $i++) {
                                        ...
                                        echo "<td class='align-middle'><div class='btn-group'><a title='Modify " . $drop['name_event'] . ' - ' . $drop['name_item'] . "' href='" . site_url() . 'drops/show_modify/' . $drop['id'] . "' class='btn btn-success btn-sm'><i class='material-icons align-middle'>settings</i></a>";
