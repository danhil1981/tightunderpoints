                            ...
                            <tbody>
                                <?php
                                    for ($i = 0; $i < count($raids_list); $i++) {
                                        ...
                                        echo "<td class='align-middle'><div class='btn-group'><a title='Modify " . $raid['description'] . "' href='" . site_url() . 'raids/show_modify/' . $raid['id'] . "' class='btn btn-primary btn-sm'><i class='material-icons align-middle'>settings</i></a>";
