                            ...
                            <tbody>
                                <?php
                                    for ($i = 0; $i < count($raids_list); $i++) {
                                        $raid = $raids_list[$i];
                                        echo "<tr><th scope='row' class='fit align-middle'>" . $raid['id'] . '</th>';
                                        echo "<td class='align-middle'>" . $raid['date'] . '</td>';
                                        echo "<td class='align-middle'>" . $raid['description'] . '</td>';
                                        echo "<td class='fit align-middle'><div class='btn-group'><a title='Modify " . $raid['description'] . "' href='" . site_url() . 'raids/show_modify/' . $raid['id'] . "' class='btn btn-success btn-sm'><i class='material-icons align-middle'>settings</i></a>";
