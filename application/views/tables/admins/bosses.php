                            ...
                            <tbody>
                                <?php
                                    for ($i = 0; $i < count($bosses_list); $i++) {
                                        ...
                                        echo '</td>';
                                        echo "<td class='align-middle'><div class='btn-group'><a title='Modify " . $boss['name'] . "' href='" . site_url() . 'bosses/show_modify/' . $boss['id'] . "' class='btn btn-success btn-sm'><i class='material-icons align-middle'>settings</i></a>";
