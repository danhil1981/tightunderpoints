                    <div id="players" class="d-none table-responsive">
                        ...
                        <table class="table table-dark table-bordered table-striped table-hover table-sm text-center"
                            id="table_players">
                            <thead>
                                <tr>
                                    <th scope="col">Id</th>
                            ...
                            <tbody>
                                <?php
                                    for ($i = 0; $i < count($players_list); $i++) {
                                        ...
                                        echo "<tr><th scope='row' class='fit align-middle'>" . $player['id'] . '</th>';
                                        echo "<td class='align-middle'>" . $player['name'] . '</td>';
                                        echo "<td class='fit align-middle'><div class='btn-group'><a title='Modify " . $player['name'] . "' href='" . site_url() . 'players/show_modify/' . $player['id'] . "' class='btn btn-success btn-sm'><i class='material-icons align-middle'>settings</i></a>";
