                            ...
                            <tbody>
                                <?php
                                    for ($i = 0; $i < count($players_list); $i++) {
                                        ...
                                        echo "<td class='align-middle'><div class='btn-group'><a title='Modify " . $player['name'] . "' href='" . site_url() . 'players/show_modify/' . $player['id'] . "' class='btn btn-primary btn-sm'><i class='material-icons align-middle'>settings</i></a>";
