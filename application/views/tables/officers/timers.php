                                ...
                                <?php
                                    ...
                                    foreach ($timers as $value) {
                                        ...
                                        if (gmdate('Y-m-d H:i:s', time() + 3600 * ($timezone + date('I'))) > $value['end_window']) {
                                            echo "<div title='Up' class='btn btn-sm btn-success'><i class='material-icons align-middle'>event_available</i></div></td><td class='align-middle'><a title='Track " . $value['name_boss'] . "' href='" . site_url() . 'events/show_insert/officers/' . $value['id_boss'] . "' class='btn btn-sm btn-primary'><i class='material-icons align-middle'>alarm_add</i></a>";
                                        } else {
                                            if (gmdate('Y-m-d H:i:s', time() + 3600 * ($timezone + date('I'))) < $value['start_window']) {
                                                ...
                                                echo "<div title='In Window' class='btn btn-sm btn-warning'><i class='material-icons align-middle'>indeterminate_check_box</i></div></td><td class='align-middle'><a title='Track " . $value['name_boss'] . "' href='" . site_url() . 'events/show_insert/officers/' . $value['id_boss'] . "' class='btn btn-sm btn-primary'><i class='material-icons align-middle'>alarm_add</i></a>";
                                            }
                                        }
                                        echo '</td></tr>';
                                    }
