                    <div id="characters" class="d-none table-responsive">
                            ...
                            <tbody>
                                <?php
                                    for ($i = 0; $i < count($characters_list); $i++) {
                                        ...
                                        echo "<tr><th scope='row' class='fit align-middle'>" . $character['id'] . '</th>';
                                        ...
                                        echo "<td class='fit align-middle'><div class='btn-group'><a title='Modify " . $character['name'] . "' href='" . site_url() . 'characters/show_modify/' . $character['id'] . "' class='btn btn-success btn-sm'><i class='material-icons align-middle'>settings</i></a>";
